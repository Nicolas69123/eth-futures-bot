#!/usr/bin/env python3
"""
🤖 Bot Multi-Paires API Key 1 - DOGE + SHIB

Lance 2 instances du bot V4 en parallèle avec API Key 1.
...
# Configuration paires pour API Key 1 (PRODUCTION: DOGE seul)
PAIRS = [
    'DOGE/USDT:USDT',
]
...
def signal_handler(sig, frame):
    print("\n\n⏹️  ARRÊT DE TOUS LES BOTS API KEY 1...")
    for p in processes:
